...
- **[grill-with-docs-codex](./grill-with-docs-codex/SKILL.md)** — Codex-optimized `grill-with-docs`: same domain-aware grilling, but asks 1–3 questions at a time via `request_user_input`.
